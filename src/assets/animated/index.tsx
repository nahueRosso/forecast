...
import thunderstorm from './thunderstorms.svg'
import snow from './snowy-3.svg'
import windSta from './windSta.svg'
import cloudSta from './cloudySta.svg'
import humiditySta from './humedad.svg'
...
export const AnimationRain = () => rain
export const AnimationThunderstorm = () => thunderstorm
export const AnimationSnow = () => snow
export const Wind = () => windSta
export const Clouds = () => cloudSta
export const Humidity = () => humiditySta
